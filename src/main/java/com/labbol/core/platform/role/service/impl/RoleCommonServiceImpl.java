 ...
 * @author PengFei
 */
public class RoleCommonServiceImpl extends BaseSsmModelService implements RoleCommonService {

	protected final LabbolModelService modelService;

	protected final RoleRightCommonService roleRightService;

	protected final RoleDataRightCommonService roleDataRightService;

	public RoleCommonServiceImpl(LabbolModelService modelService, RoleRightCommonService roleRightService,
			RoleDataRightCommonService roleDataRightService) {
		this.modelService = modelService;
		this.roleRightService = roleRightService;
		this.roleDataRightService = roleDataRightService;
	}
	...
	public List<Role> findRoleTree() {
		CombinationConditionSqlFragment combinationCondition = createCombinationSqlCondition(modelService);
		combinationCondition.and("role.roleType", "=", "01").and("role.state", "=", "0");
