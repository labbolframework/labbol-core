...
public final class Orgs {
	 ...
	 */
	public static String getConditionOrgId(LabbolModelService modelService, Org currentLoginUserOrg,
	 ...
	 * @see #getConditionOrg(SqlModelService, Org, String)
	 */
	public static String getConditionOrgNo(LabbolModelService modelService, Org currentLoginUserOrg,
			String conditionOrgId) {
		return getConditionOrg(modelService, currentLoginUserOrg, conditionOrgId).getOrgNo();
	}

	/**
	 * 比较传入的组织id与当前登录人的组织id并获取符合需求的进行查询的组织条件。 <br/>
	 * 1、如果conditionOrgId的组织不存在则默认为根组织<br/>
	 * 2、如果conditionOrgId的组织与currentLoginUserOrg均为跟组织则直接返回根组织<br/>
	 * 3、如果conditionOrgId的组织与currentLoginUserOrg相同则返回currentLoginUserOrg<br/>
	 * 4、如果currentLoginUserOrg隶属于conditionOrgId的组织则返回currentLoginUserOrg<br/>
	 * 5、如果conditionOrgId的组织隶属于currentLoginUserOrg则返回conditionOrgId<br/>
	 * 
	 ...
	 * @return
	 */
	public static Org getConditionOrg(LabbolModelService modelService, Org currentLoginUserOrg, String conditionOrgId) {
