 ...
 * @author PengFei
 */
public class ModuleCommonServiceImpl extends BaseSsmModelService implements ModuleCommonService {

	protected final LabbolModelService modelService;

	public ModuleCommonServiceImpl(LabbolModelService modelService) {
